...
TECHNICAL_FEATURES = [
    ...
    # 'rs_velocity',         # EXCLUDED: Uses benchmark RS (Close/SPY)
...
LEAKAGE_FEATURES = [
    'MFE',           # Maximum Favorable Excursion (peak during trade)
...
FEATURE_AUTO_EXCLUDE = EXCLUDE_BENCHMARK_RS + EXCLUDE_STALE_FEATURES
...
M01_FEATURES = [
    ...
    'peg_adjusted',
    # Native categorical features (XGBoost handles internally)
    'industry_id',
    'sector_id',
]

M01_NO_INDUSTRY = [f for f in M01_FEATURES if f != 'industry_id']  # For testing industry exclusion impact
